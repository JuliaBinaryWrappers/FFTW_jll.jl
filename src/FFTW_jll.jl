...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import FFTW_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f5851436-0d7a-5f13-b9de-f02708fd171a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "FFTW", artifacts_toml) for e in artifacts["FFTW"]]
...
if best_platform === nothing
    @debug("Unable to load FFTW; unsupported platform $(triplet(platform_key_abi()))")
else
